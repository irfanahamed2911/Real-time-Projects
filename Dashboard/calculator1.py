...
def init_weight_data():
    ...
    weights = [
        ...
        ("nut", "6mm", 435), ("nut", "8mm", 210), ("nut", "10mm", 167),
        ("nut", "12mm", 109), ("nut", "14mm", 80), ("nut", "16mm", 64),
        ("nut", "18mm", 55), ("nut", "20mm", 42), ("nut", "22mm", 33),
        ("nut", "24mm", 28),

        # Washers - now in pieces per kg
        ("washer", "6mm", 1000), ("washer", "8mm", 667), ("washer", "10mm", 476),
        ("washer", "12mm", 333), ("washer", "14mm", 263), ("washer", "16mm", 222),
        ("washer", "18mm", 192), ("washer", "20mm", 161), ("washer", "22mm", 141),
        ("washer", "24mm", 125),
    ]
...
def open_calculator():
    ...
    calc_win = tk.Tk()
    calc_win.title("MJ Weight Calculator")
