...
class ProductApp:
    ...
    def __init__(self, root):
        self.root = root
        self.root.title("Flange, alen cap and S/L Nut Manager")
        ...
        self.type_combo = ttk.Combobox(form_frame, textvariable=self.type_var, values=["bolt", "nut"], state="readonly", width=18)
    ...
    def add_product(self):
        try:
            ...
            size = self.length_var.get() if type_ != "nut" else ""
    ...
    def on_select(self, event):
        ...
        if selected:
            ...
            self.thread_var.set(field_map.get("Thread", ""))
    ...
    def export_to_excel(self, type_):
        ...
        folder = "Flange, alen cap and S/L Nut"
